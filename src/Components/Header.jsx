    ...
    <nav className="w-full px-4 pt-3 max-md:mr-10 max-md:mb-5">
      <ul className="w-full flex justify-between items-center">
          ...
          <a href="/">
            <li>
              <img
                src={Logo}
                alt="Logo"
                className="w-[110px] h-auto max-md:w-24 max-md:h-20"
              />
            </li>
          </a>
        </div>
        ...
        <button className="flex items-center bg-white border-[1px] border-gray-300 hover:border-gray-400 rounded-full px-4 py-2 shadow-sm hover:shadow-lg transition duration-300 max-xl:mr-2 max-md:px-4 max-md:py-2">
          ...
          <span className="text-black font-bold text-lg max-md:text-base">
            DONATE
          </span>
        </button>
        ...
        {/* Mobile Nav links */}
        <div
          className="sidebar h-[400px] mt-[500px]  bg-white absolute w-screen transform translate-x-full transition-transform duration-300 ease-in-out"
          ref={navdiv}
        >
