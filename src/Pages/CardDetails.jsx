...
const emergencyData = [
  {
    ...
    backers: 114,
    progress: "4%",
    description: "This man suffers from Elephantiasis, and he urgently needs surgery. Your donation will help him get the surgery he needs.",
  },
  {
    id: 2,
    title: "Urgent Help Needed for a Child with Heart Disease",
    author: "By Anjali Verma",
    image: "https://dkprodimages.gumlet.io/campaign/cover/Help-Krishna-Prasad1317770230.jpg?format=webp&w=360&dpr=1.3", // replace with actual image path
    totalRaised: "₹500,000",
    totalRequired: "₹1,000,000",
    backers: 220,
    progress: "50%",
    description: "A young child is suffering from a severe heart condition. The treatment and surgery are expensive, and every bit helps.",
  },
  {
    id: 3,
    ...
    backers: 150,
    progress: "37.5%",
    description: "A family lost everything in a devastating fire. Your support can help them rebuild their lives and recover from this tragedy.",
  },
  { id: 4, 
...
const CardDetails = () => {
  ...
  return (
    <div className="max-w-screen-lg mx-auto grid grid-rows-2 md:grid-cols-3 p-4 max-h-[4300px] lg:max-h-[3800px] ">

      {/* Left side */}
      <div className="lg:flex gap-8 flex-col col-span-2 ">
