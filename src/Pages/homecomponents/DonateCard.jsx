...
export default function DonateCard({ DonationData }) {
  ...
  return (
    <>
      ...
      {/*Mobile View */}
      <div className="lg:hidden block relative w-full px-4">
        {/* Navigation Buttons */}
        ...
        >
          {DonationData.map((Donation) => (
            <div
              key={Donation.id}
              className="snap-start flex-shrink-0 bg-white shadow-lg rounded-xl overflow-hidden transition-transform hover:shadow-xl w-[95%] max-w-xs"
            >
              {/* Image Section */}
              <div className="relative">
                <img
